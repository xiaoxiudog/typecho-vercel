...
I18n::setLang($options_->admin_language);
?>
        ...
        <div class="row typecho-page-main manage-metas">
                <div class="col-mb-12">
                    <ul class="typecho-option-tabs clearfix">
                        <li class="current"><a href="<?php $options->adminUrl('extending.php?panel=Handsome%2Fmanage-links.php'); ?>"><?php _me('友情链接'); ?></a></li>
<!--						<li><a href=--><?php //$options->index('/action/links-edit?do=addhanny'); ?><!-- title="如果你喜欢，可以点击快速添加寒泥的博客。">--><?php //_e('添加寒泥'); ?><!--</a></li>-->
                        <li><a href="https://auth.ihewro.com/user/docs/#/preference/page?id=%e5%8f%8b%e6%83%85%e9%93%be%e6%8e%a5" title="查看友情链接使用帮助" target="_blank"><?php _e('帮助'); ?></a></li>
                    </ul>
                </div>
                            ...
                            <tbody>
                                ...
                                <tr id="lid-<?php echo $link['lid']; ?>">
									...
									<td><?php
                                        if ($link["sort"] == "ten"){
                                            echo "全站链接";
                                        }else if ($link["sort"]== "one"){
                                            echo "内页链接";
                                        }elseif ($link["sort"] == "good"){
                                            echo "推荐链接";
                                        }else{
                                            echo "失效链接";
                                        } ?></td>
									<td><?php
										if ($link['image']) {
											...
											$nopic_url = Typecho_Common::url('/usr/plugins/Handsome/assets/image/nopic.jpg',
                                                $options->siteUrl);
                ...
                <div class="col-mb-12 col-tb-4" role="form">
                    <?php Handsome_Plugin::form()->render(); ?>
                </div>
        </div>
    </div>
</div>
